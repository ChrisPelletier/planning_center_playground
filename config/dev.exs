...
config :planning_center_playground, PlanningCenterPlayground.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "planning_center_playground_dev",
  stacktrace: true,
...
config :planning_center_playground, PlanningCenterPlaygroundWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/planning_center_playground_web/router\.ex$"E,
      ~r"lib/planning_center_playground_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :planning_center_playground, dev_routes: true
